...
const TermsOfService = () => {
  return (
    <div className="ga-black-default scrollbar-thin scrollbar-thumb-ga-white-default scrollbar-track-ga-purple-darkest scrollbar flex min-h-screen flex-col justify-between gap-12">
      <StarsBackground />
